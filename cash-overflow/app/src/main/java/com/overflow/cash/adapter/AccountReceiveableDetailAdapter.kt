...
import kotlinx.android.synthetic.main.adapter_account_receiveable_detail.view.*
 ...
 */
class AccountReceiveableDetailAdapter(private val translations: Translations) : RecyclerView.Adapter<AccountReceiveableDetailAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.adapter_account_receiveable_detail, parent, false)
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val createdAt:TextView = view.tvCreatedAt
        val receiveableDate:TextView = view.tvReceiveableDate
        val orderCode:TextView = view.tvOrderCode
        val paymentAmount:TextView = view.tvPaymentAmount
    }
}
