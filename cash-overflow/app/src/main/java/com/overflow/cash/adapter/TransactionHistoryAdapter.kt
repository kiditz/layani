 ...
 */
class TransactionHistoryAdapter(private val translations: Translations, private val format:SimpleDateFormat) : RecyclerView.Adapter<TransactionHistoryAdapter.ViewHolder>() {
