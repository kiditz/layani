...
import com.overflow.cash.adapter.ProviderAdapter
...
class PulsaProductListByProviderFragment : BaseFragment(), LoadPulsaProductByProviderContract.View, SendOrderPulsaContract.View, LoadProviderByCategoryContract.View {
    @Inject
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        this.adapter = PulsaPaketProductAdapter()
        this.providerAdapter = ProviderAdapter(imageService, activity!!)
        this.sp_provider?.adapter = providerAdapter
    ...
    private fun initLoadProduct() {
        ...
        sp_provider?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                Timber.i("Provider : %s", provider.getString("name"))
                loadPulsaProductByProviderPresenter.loadProduct(currentPage, providerId)
            }
    ...
    override fun onProviderLoaded(providerList: List<Data>) {
        ...
        this.providerAdapter.addAll(providerList)
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        loadPulsaProductByProviderPresenter.detach()
        loadProviderByCategoryPresenter.detach()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(bundle: Bundle, hint: String, showPhoneNumber: Boolean = true) =
                PulsaProductListByProviderFragment().apply {
                    arguments = bundle
