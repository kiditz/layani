...
class ProfitChartPresenter(private val context: Context, private val preferences: SharedPreferences, private val translations: Translations, private val orderService:OrderService, private val disposable: CompositeDisposable) : ProfitChartContract.Presenter {
    lateinit var view : ProfitChartContract.View
    ...
    override fun attach(view: ProfitChartContract.View) {
        this.view = view
