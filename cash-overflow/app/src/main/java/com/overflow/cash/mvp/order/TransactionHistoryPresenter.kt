...
class TransactionHistoryPresenter(private val context:Context, private val preferences: SharedPreferences, private val translations: Translations, private val orderService: OrderService, private val disposable: CompositeDisposable) :TransactionHistoryContract.Presenter{

    lateinit var view:TransactionHistoryContract.View
    ...
    override fun attach(view: TransactionHistoryContract.View) {
        this.view = view
