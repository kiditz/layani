...
class LoadProductPresenter(private var context: Context, private var translations: Translations, private var disposable: CompositeDisposable, private var productService: ProductService, private var preferences: SharedPreferences): LoadProductContract.Presenter {

    lateinit var view: LoadProductContract.View
    var lastPage:Boolean = true
    var loading:Boolean = true

    override fun attach(view: LoadProductContract.View) {
        this.view = view
    }
