...
public final class MimeUtils {
    ...
    public static boolean hasMimeType(String mimeType) {
        return !(mimeType == null || mimeType.length() == 0) && MIME_TYPE_TO_EXTENSION_MAP.containsKey(mimeType);
    }
    /**
    ...
    public static boolean hasExtension(String extension) {
        return !(extension == null || extension.length() == 0) && EXTENSION_TO_MIME_TYPE_MAP.containsKey(extension);
    }
    /**
